          ...
          const initialFeatures = [
            {
              ...
              status: 'shipped' as const, priority: 'high' as const, area: 'editor' as const,
            ...
            },
            {
              ...
              status: 'shipped' as const, priority: 'high' as const, area: 'autoblog' as const,
              requestedBy: 'Carol', requestedAt: new Date('2026-08-21T10:35:00').toISOString(),
            ...
            },
            {
              ...
              status: 'shipped' as const, priority: 'critical' as const, area: 'dashboard' as const,
              requestedBy: 'Carol', requestedAt: new Date('2026-08-25T12:15:00').toISOString(),
            ...
            },
            {
              ...
              status: 'shipped' as const, priority: 'critical' as const, area: 'editor' as const,
            ...
            },
            {
              ...
              status: 'shipped' as const, priority: 'high' as const, area: 'deployment' as const,
              requestedBy: 'Carol', requestedAt: new Date('2026-08-29T23:30:00').toISOString(),
            ...
            },
            {
              ...
              status: 'shipped' as const, priority: 'critical' as const, area: 'wordpress' as const,
              requestedBy: 'Carol', requestedAt: new Date('2026-08-29T23:30:00').toISOString(),
